...
<!--                <li><button onclick="live_chat()">Live Chat</a></li>-->
	...
	<div class="container" id="frame">
		<div class="col-md-6">
			...
			<ul>
<!--				
<li>Explore hotels on MyTickets.com (no login needed)</li>-->
			...
			<div id="form-container" style="width: 90%;margin: auto;">
				...
				<div id="register_form" style="border: 1px solid gray;border-radius: 6px;">
					<form action="http://localhost/wt2/reg.php" method="POST" target="hframe">
						<label>&nbsp;&nbsp;&nbsp;Name</label><br/>
						<input id="inp" type="text" name="name" required onkeypress="check_validity_name(this)">
        ...
        <p style="margin:500px 100%;" >
            <button onclick="live_chat()" class="btn btn-primary" style="width: 150px; height: 100px">Chat with us</button>
        </p>
